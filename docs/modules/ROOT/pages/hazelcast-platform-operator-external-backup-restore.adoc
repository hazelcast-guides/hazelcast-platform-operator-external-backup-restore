...
----
kubectl apply -f - <<EOF
include::ROOT:example$/map-persistence.yaml[]
EOF
----
...
----
+
The sample code(excluding CLC) for this tutorial is in the link:https://github.com/hazelcast-guides/hazelcast-platform-operator-external-backup-restore/tree/master/docs/modules/ROOT/examples[`docs/modules/ROOT/examples/`] directory.
...
[source, cs]
----
include::ROOT:example$/dotnet/Program.cs[]
----
--
